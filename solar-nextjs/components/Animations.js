    ...
    function initAnimations() {
      ...
      ctx = gsap.context(() => {
        ...
        gsap.from('.products-tabs', {
          ...
          scrollTrigger: { trigger: '#products', start: 'top 70%' }
        });
        gsap.from('.product-viewer', {
          opacity: 0, x: -50, duration: 0.8,
          scrollTrigger: { trigger: '.products-showcase', start: 'top 70%' }
        });
        ...
        gsap.from('.process-line::after', {
          ...
          scrollTrigger: { trigger: '#process', start: 'top 60%', end: 'center center', scrub: 1 }
        });
        ...
        gsap.from('.calculator-card', {
          opacity: 0, y: 50, scale: 0.95, duration: 0.8,
          scrollTrigger: { trigger: '#calculator', start: 'top 70%' }
        });
        ...
        gsap.from('.cert-badge', {
          opacity: 0, scale: 0.8, duration: 0.5, stagger: 0.1,
          scrollTrigger: { trigger: '.certifications-grid', start: 'top 90%' }
        });
